...
<body>
    <div class="form-container">
        ...
        <form class="form-horizontal" action="job" method="post">
            ...
            <div class="form-group">
                <label class="control-label col-sm-3" for="college-name">College Name:</label>
                <div class="col-sm-9">
                    <input type="text" class="form-control" id="college-name" placeholder="Enter college name" name="collegeName">
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <label class="control-label col-sm-3" for="experience">Experience (in years):</label>
                <div class="col-sm-9">
